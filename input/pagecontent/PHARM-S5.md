This section corresponds to transaction [PHARM-S5] of the IHE Technical Framework. Transaction [PHARM-S5] is used by the ... and the ... actors. The Supply Request [PHARM-S5] transaction is used to ....
