...
* containedItem 1..1 Reference(ItemModel) "The contained item" "The contained item"
...
* dimensions.value 1..1 SimpleQuantity "The dimension value" "The dimension value"
...
* attributes.value[x] 0..1 integer or string or boolean "The value of the attribute" "The value of the attribute"
...
* association.associatedProduct[x] 1..1 CodeableConcept or Reference(ProductModel or ItemModel) "The associated product - by code or reference" "The associated product - by code or reference"
...
* association 0..* BackboneElement "For example, Product A (powder) should be mixed with product B '(saline)', or 'product A should be applied with device B' , or 'Product X applies to parent device Y"
* association.associationType 1..1 CodeableConcept "The type of association" "e.g. 'applied with' or 'used with' or 'to be mixed with"
* association.associatedProduct[x] 1..1 CodeableConcept or Reference(ProductModel or ItemModel) "The actual related product" "The actual related product"
* association.associatedProductCodeableConcept from vs-ihe-pharm-product-association-type (preferred)
